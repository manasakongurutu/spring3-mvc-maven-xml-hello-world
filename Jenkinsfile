...
stage("scm"){​​​​​
steps{​​​​​
git "https://github.com/manasakongurutu/spring3-mvc-maven-xml-hello-world.git"
}​​​​​
}​​​​​
stage("build"){​​​​​
steps{​​​​​
...
docker run -it -d -p 8083:8080 --name test_${​​​​​BUILD_NUMBER}​​​​​ manasamidhuna/test:${​​​​​BUILD_NUMBER}​​​​​
"""
}​​​​​
}​​​​​
}​​​​​
